...
async function checkAPIStatus() {
  ...
  if (result.status) {
    ...
    icon.innerHTML =
      "<i class='fa-solid fa-circle-xmark' style='color: #e74c3c;' title='" +
      result.message.normalize() +
      "'></i>";
...
async function checkWebDAVStatus() {
  document.getElementById("webdav_status").innerHTML =
    "<i class='fa-solid fa-spinner fa-spin'></i>";
...
async function checkLDAPStatus() {
  document.getElementById("ldap_status").innerHTML =
    "<i class='fa-solid fa-spinner fa-spin'></i>";
...
async function checkLDAPAccessStatus() {
  document.getElementById("ldap-access_status").innerHTML =
    "<i class='fa-solid fa-spinner fa-spin'></i>";
...
function checkInput() {
  ...
  const edulutionui_external_domain = document.getElementById(
    "edulutionui_external_domain"
  );
...
function loadDomain() {
  document.getElementById("edulutionui_external_domain").value =
...
function loadCertificateContent(certificate_type) {
  ...
  document.getElementById("content_" + certificate_type.value).style.display =
    "block";
}
...
function checkCertificateInput() {
  ...
  if (
    cert_domain_valid &&
    cert_country_code_valid &&
    cert_state_valid &&
    cert_city_valid &&
    cert_organisation_valid &&
    cert_valid_days_valid
  ) {
...
async function generateSSCertificate() {
  ...
  const ss_certificate_status = document.getElementById(
    "ss_certificate_status"
  );
  ss_certificate_status.innerHTML =
    "<i class='fa-solid fa-spinner fa-spin'></i>";
...
async function createLECertificate() {
  ...
  const le_certificate_status = document.getElementById(
    "le_certificate_status"
  );
  le_certificate_status.innerHTML =
    "<i class='fa-solid fa-spinner fa-spin'></i>";
...
async function uploadCertificate() {
  ...
  const upload_certificate_status = document.getElementById(
    "upload_certificate_status"
  );
  upload_certificate_status.innerHTML =
    "<i class='fa-solid fa-spinner fa-spin'></i>";
